...
#######################
set_property IOSTANDARD LVCMOS25 [get_ports {myriadrf_*}]
set_property PACKAGE_PIN T16 [get_ports myriadrf_spi_io0_io]
set_property PACKAGE_PIN U17 [get_ports myriadrf_spi_io1_io]
set_property PACKAGE_PIN V16 [get_ports myriadrf_spi_sck_io]
set_property PACKAGE_PIN W16 [get_ports {myriadrf_spi_ss_io[0]}]
